...
#songs_df = songs_df[['song_id', 'genre_ids', 'genre_count', 'artist_count', 'composer_count', 'lyricist_count', 'song_year','language','song_length', 'play_count','replay_count', 'replay_pb']].drop_duplicates('song_id')
...
# #进行归一化
# #songs_df1 = songs_df[['genre_count', 'artistId', 'artist_count', 'composerId', 'composer_count', 'lyricistId', 'lyricist_count', 'song_year','language','song_length', 'play_count','replay_count', 'replay_pb']]
# songs_df1 = songs_df[['genre_count',  'artist_count', 'composer_count',  'lyricist_count', 'song_year','language','song_length', 'play_count','replay_count', 'replay_pb']]
# songs_df1 = songs_df1.apply(lambda x: (x - np.min(x)) / (np.max(x) - np.min(x)))
# songs_df1['song_id'] = songs_df['song_id']
# songs_df1['genre_ids'] = songs_df['genre_ids']
# #songs_df1 = songs_df1[['song_id', 'genre_ids', 'genre_count', 'artistId', 'artist_count', 'composerId', 'composer_count', 'lyricistId', 'lyricist_count', 'song_year','language','song_length', 'play_count','replay_count', 'replay_pb']].drop_duplicates('song_id')
# songs_df1 = songs_df1[['song_id', 'genre_ids', 'genre_count', 'artist_count', 'composer_count',  'lyricist_count', 'song_year','language','song_length', 'play_count','replay_count', 'replay_pb']].drop_duplicates('song_id')
