...
# plt.show()
plt.savefig('members_clusterId.png', dpi=240)

#===========================songs============================#


cluster_songs_df = pd.read_csv('data/kmeans_song.csv')
songs_df = pd.read_csv('data/temp_song.csv')
...
g.set_yscale('log', nonposy='clip')
# plt.show()
plt.savefig('songs_clusterId.png', dpi=240)
